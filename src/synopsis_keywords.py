...
def generateSynopsisKeywords():
    ...
    # null_lines = anime_synopsis_df[(anime_synopsis_df['sypnopsis'].isnull() == True)]
    # print('Number of non-null lines: ', len(null_lines))
    # Output: Number of non-null lines:  0

    # no_synopsis_lines = anime_synopsis_df[anime_synopsis_df['sypnopsis'].str.contains('No synopsis')]
    ...
    no_synopsis_filter = ~anime_synopsis_df['sypnopsis'].str.contains('No synopsis')
    anime_synopsis_df = anime_synopsis_df[no_synopsis_filter]

    print("[GenerateSynopsisKeywords] Normalizing synopsis...")
    anime_synopsis_df['Synopsis_Keywords'] = anime_synopsis_df['sypnopsis'].apply(normalizeTextToKeywords)
